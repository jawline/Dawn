 ...
 * @param unsigned char sc, the scancode. uint32_t flags, the flags supplied with the scancode (Uppercase, Shifted, Etc)
 * @return ASCI Character from the scan code if found.
 */

extern char getAsciFromScancode(unsigned char sc, uint32_t flags);
