...
void initializeKernel(struct multiboot* mboot_ptr, uint32 initial_esp);
...
/**
 ...
 @callgraph
 */
int entry_point(struct multiboot* mboot, uint32 stack_ptr /* Pointer to the stack pointer */)
{
